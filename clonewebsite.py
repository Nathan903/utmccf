...
print_and_log(f"\t\tDONE: clonewebsite.py finished with {warning_counter} warnings and {error_counter} errors. Last updated {datetime.datetime.now(pytz.timezone('America/Toronto')).strftime('%Y-%m-%d %H:%M:%S %Z') }\n")
