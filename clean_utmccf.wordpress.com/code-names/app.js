const WORD_CATEGORIES = {
    "日常": ["搅拌", "企鹅", "牙签", "焊接", "银河", "泥石流", "卸载", "睫毛膏", "拖拉机", "咀嚼", "铁锈", "护照", "缝纫", "陨石", "闪烁", "逃跑", "显微镜", "扳手", "拦截", "字典", "融化", "朗读", "攀爬", "坠落", "雷达", "抽屉", "打呼噜", "火花", "折叠", "骆驼", "马桶刷", "发酵", "天线", "骨折", "橡皮泥", "冬眠", "螺丝钉", "跳伞"],
    "日常2": ["存在", "忽略", "趋势", "象征", "频率", "氛围", "循环", "犹豫", "现象", "边缘", "偶然", "状态", "延续", "虚无", "结构", "漂浮", "属性", "概念", "消耗", "距离", "瞬间", "逻辑", "节奏", "痕迹", "转化", "平衡", "幅度", "隐蔽", "流失", "反馈", "容量", "阶段", "渗透", "错觉", "本质", "交替", "分配", "局限"],
    "悬疑推理": ["线索", "动机", "现场", "指纹", "密室", "嫌疑人", "证人", "伪装", "毒药", "匕首", "绑架", "赎金", "追捕", "卧底", "档案", "密码", "保险箱", "脚印", "审讯", "谎言", "陷阱", "倒计时", "警报", "监控", "迷宫", "钥匙", "遗嘱", "侦探", "真相", "黑夜", "交易", "证据", "逃犯", "悬赏", "法医", "不在场证明"],
    "日常3": ["包袱", "水分", "火候", "风向", "底牌", "空白", "沉淀", "结晶", "磁场", "盲区", "泡沫", "跳板", "温床", "暗礁", "杠杆", "窗口", "标签", "光环", "筹码", "轨迹", "滤镜", "剧本", "触角", "文章", "阵地", "气候", "过渡", "框架", "缝隙", "色彩", "温度", "弹性", "空间", "土壤", "台阶", "死角", "开关", "纽带", "阴影", "焦点"],
    "武侠仙侠": ["江湖", "剑客", "掌门", "闭关", "秘籍", "天涯"],
    "职场生存": ["老板", "同事", "加班", "辞职", "汇报", "甩锅", "方案", "客户", "预算", "报销", "团建", "奖金", "升职", "降薪", "裁员", "考勤", "打卡", "请假", "退休", "实习生", "董事会", "股份", "跳槽", "绩效", "邮件", "会议室", "咖啡机", "竞争", "签单", "摸鱼", "内卷", "早退", "前台", "合同", "期权"],
       "单字": ["铁", "票", "酸", "鼓", "盘", "刷", "灰", "猫", "针", "泡", "扇", "扣", "算", "包", "塔", "圈", "墨", "伞", "霜", "牌", "汤", "账", "弦", "码", "挂", "锅", "刀", "染", "豆", "轴", "潮", "洞", "砖", "兽", "膜", "钉", "浆", "妖", "榜", "贼"],
    ...
    "蔬菜水果": [ "西兰花", "韭菜", "香菜", "葱", "苹果", "香蕉", "柠檬",  "葡萄", "芒果", "菠萝","猕猴桃"],
    ...
    "哲学": [ "二元论", "唯物主义", "唯心主义", "决定论", "自由意志", "存在主义", "理性主义", "先验", "怀疑论", "现象学", "实用主义", "不可知论", "伦理学", "功利主义", "相对主义", "虚无主义",],
...
function renderBoard(words, colors, cols) {
    ...
    words.forEach((word, index) => {
        ...
        btn.addEventListener('click', () => {
            ...
            // Only show images if time is past 2026-06-05 6:35 PM EST (UTC-5)
            const unlockTime = new Date('2026-06-05T18:45:00-04:00').getTime();
