...
DOC_ID = "1xa4INCV15X9SOtmQFe-5XWM4eyxAmmnGvj-pa0yy2MM"
site_title = "敬拜夜歌词 Worship Night Lyrics"
...
def to_url_safe(title):
    ...
    return f"{title[:50]}".lower()+("_" if title else "")+hashstr # Limit filename length
...
def generate_blog_pages(markdown_strings):    
    ...
    index_page = create_html_page(index_content, site_title, nav_links=nav_links)
